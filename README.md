...
> This README is lifted from the original template [here](https://github.com/dustinlyons/nixos-config/blob/main/README.md). Holding onto a snapshot so I know how the secrets stuff is supposed to work, since I'm not really using that yet.
